...
export const dbConnection = async () => {
    try {
        ...
        mongoose.connection.on('open', () => {
            console.log('MongoDB | conectado a la base de datos restaurantesdb');
        })
...
const gracefulShutdown = async(signal) => {
    ...
    try {
        ...
        console.log('MongoDB | Database connecting closed succesful');
        process.exit(0);
    } catch (error) {
...
process.on('SIGIN', () => gracefulShutdown('SIGIN'));
