...
// Modelo UserUsernameChange
export const UserUsernameChange = sequelize.define(
    'UserUsernameChange',
    {
        Id: {
            type: DataTypes.STRING(16),
        ...
        UsernameChangeToken: {
            type: DataTypes.STRING(256),
            allowNull: true,
            field: 'username_change_token',
        },
        UsernameChangeTokenExpiry: {
            type: DataTypes.DATE,
            allowNull: true,
            field: 'username_change_token_expiry',
        },
    },
    {
        tableName: 'user_username_changes',
        timestamps: false,
    }
);

// Modelo UserPhoneChange
export const UserPhoneChange = sequelize.define(
    'UserPhoneChange',
    {
        Id: {
            type: DataTypes.STRING(16),
        ...
        PhoneChangeToken: {
            type: DataTypes.STRING(256),
            allowNull: true,
            field: 'phone_change_token',
        },
        PhoneChangeTokenExpiry: {
            type: DataTypes.DATE,
            allowNull: true,
            field: 'phone_change_token_expiry',
        },
    },
    {
        tableName: 'user_phone_changes',
        timestamps: false,
    }
);
...
// Relaciones
User.hasOne(UserUsernameChange, { foreignKey: 'user_id', as: 'UserUsernameChange' });
UserUsernameChange.belongsTo(User, { foreignKey: 'user_id', as: 'User' });

User.hasOne(UserPhoneChange, { foreignKey: 'user_id', as: 'UserPhoneChange' });
UserPhoneChange.belongsTo(User, { foreignKey: 'user_id', as: 'User' });
