...
import { Award, ShieldCheck, Globe, ArrowRight, MousePointer2, Diamond, Crown } from "lucide-react";
...
const FeatureCard = ({ icon, title, desc }) => (
    <div className="group relative bg-white p-6 sm:p-8 lg:p-12 transition-all duration-500 border-l border-slate-100 hover:bg-slate-50 overflow-hidden">
        ...
        <div className="relative z-10">
            ...
            <h3 className="mb-4 text-base sm:text-lg font-black text-slate-900 tracking-[0.12em] sm:tracking-[0.2em] uppercase group-hover:text-amber-600 transition-colors duration-500">
                {title}
            </h3>
...
const StatCard = ({ value, label }) => (
    <div className="flex min-w-0 flex-col items-center group px-3 sm:px-8 text-center">
        ...
        <p className="text-[10px] font-black uppercase tracking-[0.24em] sm:tracking-[0.6em] text-slate-300 group-hover:text-slate-500 transition-colors break-words">{label}</p>
    </div>
);
    ...
    return (
        <div className="w-full space-y-0 bg-white selection:bg-amber-100">
            ...
            <section className="group/hero relative w-full overflow-hidden bg-white min-h-[500px] md:min-h-[700px] flex items-center border-b border-slate-50">
                ...
                <div className="relative z-10 w-full px-5 sm:px-6 md:px-16 lg:px-32 py-20 md:py-0">
                    <div className="max-w-4xl animate-in fade-in slide-in-from-bottom duration-1000">
                        ...
                        <h1 className="text-4xl sm:text-5xl md:text-8xl font-extralight text-slate-950 tracking-tighter leading-[1] md:leading-[0.9] mb-8 md:mb-10 italic">
                            Redefiniendo el<br />
            ...
            <section className="w-full bg-white py-16 md:py-24 border-b border-slate-50">
                <div className="max-w-[1500px] mx-auto grid grid-cols-2 lg:flex lg:justify-center gap-y-12 gap-x-4 sm:gap-x-8 md:gap-24 lg:gap-32 px-4">
            ...
            <section className="w-full py-20 md:py-32 overflow-hidden">
                <div className="text-center space-y-6 mb-16 md:mb-24 px-4">
                    <span className="text-[10px] md:text-[11px] font-black uppercase tracking-[0.35em] md:tracking-[0.7em] text-amber-600">Curaduría</span>
                    <h2 className="text-4xl md:text-6xl font-extralight text-slate-950 tracking-tighter italic">Tendencias</h2>
            ...
            <section className="w-full py-32 px-6 md:px-16 lg:px-32 bg-[#fafafa]">
                <div className="max-w-[1400px] mx-auto grid lg:grid-cols-2 gap-24 items-center">
                    ...
                    <div className="relative aspect-square md:aspect-video lg:aspect-square overflow-hidden rounded-[2rem] md:rounded-[3rem] shadow-2xl border-8 md:border-[16px] border-white">
                        <img src={res2} alt="" className="h-full w-full object-cover" />
                        <div className="absolute inset-0 bg-slate-950/20" />
                        <div className="absolute bottom-4 left-4 right-4 sm:right-auto sm:bottom-12 sm:left-12 bg-white p-5 sm:p-8 rounded-3xl shadow-2xl">
                            <p className="text-2xl sm:text-3xl font-black text-slate-900 italic mb-1">99.8%</p>
                            <p className="text-[9px] sm:text-[10px] font-black uppercase tracking-widest text-slate-400">Satisfacción Élite</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="w-full py-32 px-6 relative overflow-hidden bg-slate-950">
                ...
                <div className="relative z-10 max-w-4xl mx-auto text-center space-y-10">
                    ...
                    <h2 className="text-5xl md:text-7xl font-extralight text-white tracking-tighter italic leading-none">
                        ...
                        <span className="font-black text-amber-500 not-italic uppercase tracking-[0.06em] sm:tracking-[0.1em] text-4xl md:text-6xl">a un click.</span>
                    </h2>
                    ...
                    <div className="pt-6">
                        <Link
                            to="/home/restaurants"
                            className="inline-flex w-full sm:w-auto items-center justify-center gap-4 sm:gap-6 bg-amber-500 text-slate-950 px-8 sm:px-16 py-5 sm:py-7 rounded-full text-[11px] sm:text-[12px] font-black uppercase tracking-[0.24em] sm:tracking-[0.5em] hover:bg-white transition-all active:scale-95 shadow-2xl shadow-amber-500/20"
                        >
                            Comenzar Ahora
                            <ArrowRight size={18} />
                        </Link>
